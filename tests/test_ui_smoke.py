...
class AccessRegisterUiSmokeTests(unittest.TestCase):
    ...
    def test_static_ui_assets_expose_smoke_controls(self):
        ...
        self.assertIn('id="quickSearchResults"', html)
        self.assertIn('id="profileView"', html)
        self.assertIn('id="employeeProfile"', html)
        self.assertIn('id="trackingView"', html)
        self.assertIn('id="trackingBoard"', html)
        ...
        self.assertIn("function routeFromLocation", app_js)
        self.assertIn("function updateRouteHistory", app_js)
        self.assertIn("window.history.pushState", app_js)
        ...
        self.assertIn('class="detail-form employee-edit-form"', app_js)
        self.assertIn("Save profile to database", app_js)
