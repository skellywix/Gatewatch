...
ensure_group "Gatewatch Supervisors" "Gatewatch test supervisors"
ensure_group "Gatewatch HR" "Gatewatch test HR users"
ensure_group "Gatewatch Reviewers" "Gatewatch test reviewers"
ensure_group "Gatewatch ReadOnly" "Gatewatch test read-only users"
ensure_group "AccessRegister-Admins" "Gatewatch production-style administrators"
ensure_group "AccessRegister-Supervisors" "Gatewatch production-style supervisors"
ensure_group "AccessRegister-HR" "Gatewatch production-style HR users"
ensure_group "AccessRegister-Reviewers" "Gatewatch production-style reviewers"
ensure_group "AccessRegister-ReadOnly" "Gatewatch production-style read-only users"

ensure_user "gw.admin" "$ADMIN_PASSWORD" "Grace" "Admin" "gw.admin@gatewatch.test" "E-AD-5001" "Information Security" "HQ" "true"
ensure_user "gw.supervisor" "$ADMIN_PASSWORD" "Sam" "Supervisor" "gw.supervisor@gatewatch.test" "E-AD-5002" "Operations" "HQ" "true"
ensure_user "gw.hr" "$ADMIN_PASSWORD" "Harper" "HR" "gw.hr@gatewatch.test" "E-AD-5003" "People" "HQ" "true"
ensure_user "gw.reviewer" "$ADMIN_PASSWORD" "Riley" "Reviewer" "gw.reviewer@gatewatch.test" "E-AD-5004" "Compliance" "HQ" "true"
ensure_user "gw.readonly" "$ADMIN_PASSWORD" "Remy" "ReadOnly" "gw.readonly@gatewatch.test" "E-AD-5005" "Audit" "Remote" "true"
...
ensure_member "Gatewatch Supervisors" "gw.supervisor"
ensure_member "Gatewatch HR" "gw.hr"
ensure_member "Gatewatch Reviewers" "gw.reviewer"
ensure_member "Gatewatch ReadOnly" "gw.readonly"
ensure_member "AccessRegister-Admins" "gw.admin"
ensure_member "AccessRegister-Admins" "svc.gatewatch.adsync"
ensure_member "AccessRegister-Supervisors" "gw.supervisor"
ensure_member "AccessRegister-HR" "gw.hr"
ensure_member "AccessRegister-Reviewers" "gw.reviewer"
ensure_member "AccessRegister-ReadOnly" "gw.readonly"
